 ...
 *   本文件提供 Kotlin 的 `@Serializable` 映射，服务于 [top.resderx.rac.a2a.A2aClient] 与 [top.resderx.rac.a2a.A2aAgentServer]
 ...
 *
 * 文件内容：
 * - [top.resderx.rac.a2a.Task] / [top.resderx.rac.a2a.TaskState] / [top.resderx.rac.a2a.TaskStatus]：任务模型与生命周期状态
 * - [top.resderx.rac.a2a.Message] / [top.resderx.rac.a2a.Role]：消息模型
 * - [top.resderx.rac.a2a.FilePartBody] / [top.resderx.rac.a2a.DataPartBody]：Part 内嵌类型
 * - [top.resderx.rac.a2a.A2aMetadata]：元数据键值对
 */
 ...
 * A2A 消息——一次通信轮次。
 *
 * - 作用：承载 user 或 agent 角色的内容，由一组 [top.resderx.rac.a2a.Part] 构成
 * - 边缘：`taskId` 用于关联任务上下文；[top.resderx.rac.a2a.Task.history] 存储消息列表
 *
 * @property role 消息角色
