 ...
 *
 * 文件内容：
 * - [AgentCard]：Agent Card 主文档
 * - [AgentProvider]：Agent 提供方信息
 * - [AgentCapabilities]：Agent 能力声明（流式、推送通知等）
 * - [AgentSkill]：Agent 技能描述
 * - [AgentInterface]：Agent 服务接口（协议 + URL）
 * - [AgentExtension]：Agent 扩展声明
 * - [SecurityScheme] / [APIKeySecurityScheme]：鉴权方案
 */
 ...
 * 鉴权方案密封接口，支持多种鉴权方式。
 *
 * - 当前仅实现 [APIKeySecurityScheme]；OAuth 等可后续扩展
 */
@Serializable
