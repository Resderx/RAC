 ...
 *   请求参数与响应结果数据类，供 [top.resderx.rac.a2a.A2aClient] 与 [top.resderx.rac.a2a.A2aAgentServer] 序列化使用
 ...
 *
 * 文件内容：
 * - [top.resderx.rac.a2a.SendMessageParams] / [top.resderx.rac.a2a.SendMessageResult]：tasks/send 方法
 * - [top.resderx.rac.a2a.SendStreamingMessageParams]：tasks/sendSubscribe 方法（流式，结果通过 SSE 事件推送）
 * - [top.resderx.rac.a2a.GetTaskParams] / [top.resderx.rac.a2a.GetTaskResult]：tasks/get 方法
 * - [top.resderx.rac.a2a.ListTasksParams] / [top.resderx.rac.a2a.ListTasksResult]：tasks/list 方法
 * - [top.resderx.rac.a2a.CancelTaskParams] / [top.resderx.rac.a2a.CancelTaskResult]：tasks/cancel 方法
 * - [top.resderx.rac.a2a.TaskStatusUpdateEvent] / [top.resderx.rac.a2a.TaskArtifactUpdateEvent]：流式更新事件
 * - [top.resderx.rac.a2a.A2aError]：A2A 协议错误码常量
 */
...
/**
 * tasks/sendSubscribe 方法参数（流式版本，与 [top.resderx.rac.a2a.SendMessageParams] 结构一致）。
 */
@Serializable
