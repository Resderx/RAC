 ...
 *
 * - 作用：在 [top.resderx.rac.a2a.A2aAgentHandler] 的 sendMessage/sendStreamingMessage 方法中，
 ...
 * - 实现：由 [top.resderx.rac.a2a.A2aAgentServer] 内部实现，通过 SSE 连接推送 JSON-RPC 通知
 ...
 *
 * - 作用：抽象 A2A Agent 的核心操作（消息处理、任务管理），由 [top.resderx.rac.a2a.A2aAgentServer] 在收到
 ...
 *   3. sendStreamingMessage 处理流式消息，通过 [top.resderx.rac.a2a.A2aAgentContext] 推送更新
